...
const checkOut = () => {
    location.reload();
    let data =
        '\r User ID: ' + userData.userId + ' \r\n ' +
        'First Name: ' + userData.fname + ' \r\n ' +
        'Last Name: ' + userData.lname + ' \r\n ' +
        'Email: ' + userData.email + ' \r\n ' +
        'Phone Num: ' + userData.phoneNum + '\r\n ' +
        'Reference Code: ' + userData.refCoder + '\r\n ' +
...
function quantityUpdate(num, buttonNumber, price) {
    ...
    document.getElementsByClassName("totalPrice")[buttonNumber].value = "$" + Number(document.getElementsByClassName("quantity")[buttonNumber].value) * Number(price);
